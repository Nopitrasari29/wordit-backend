...
-- CreateEnum
CREATE TYPE "EducationLevel" AS ENUM ('SD', 'SMP', 'SMA', 'UNIVERSITY');

-- CreateEnum
CREATE TYPE "TemplateType" AS ENUM ('ANAGRAM', 'FLASHCARD', 'HANGMAN', 'MAZE_CHASE', 'SPIN_THE_WHEEL', 'WORD_SEARCH');
...
-- CreateIndex
CREATE INDEX "games_educationLevel_templateType_idx" ON "games"("educationLevel", "templateType");
