...
export const seedUsers = async () => {
  ...
  const users = [
    ...
    {
      name: "Cantika (Super Admin)",
      email: "cantikasarihermawan@gmail.com",
    ...
    {
      name: "Novi (Super Admin)",
      email: "anovitriasari05@gmail.com",
      password: await hashPassword("password123"),
      role: Role.SUPER_ADMIN,
      approvalStatus: ApprovalStatus.APPROVED,
      educationLevels: [] as EducationLevel[],
    ...
    {
      name: "Syela (Super Admin)",
      email: "syelazeruya19@gmail.com",
      password: await hashPassword("password123"),
      role: Role.SUPER_ADMIN,
      approvalStatus: ApprovalStatus.APPROVED,
      educationLevels: [] as EducationLevel[],
    ...
    {
      name: "Rafika (Super Admin)",
      email: "rafikaazzahrak@gmail.com",
      password: await hashPassword("password123"),
      role: Role.SUPER_ADMIN,
      approvalStatus: ApprovalStatus.APPROVED,
      educationLevels: [] as EducationLevel[],
